...
def init_config():
    ...
    class Args:
        def __init__(self, config, username, password, list, speed) -> None:
            self.config = config
    ...
    args = Args(None, None, None, None, 1.0)
    ...
    if args.config:
        ...
        return (
        args.username, args.password, args.list.split(",") if args.list else None, int(args.speed) if args.speed else 1,
        None)
